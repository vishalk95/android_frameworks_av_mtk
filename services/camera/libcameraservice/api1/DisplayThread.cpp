 ...
 *
 ******************************************************************************/
#define MY_LOGV(fmt, arg...)        ALOGV("[DisplayThread::%s] " fmt, __FUNCTION__, ##arg)
#define MY_LOGD(fmt, arg...)        ALOGD("[DisplayThread::%s] " fmt, __FUNCTION__, ##arg)
#define MY_LOGI(fmt, arg...)        ALOGI("[DisplayThread::%s] " fmt, __FUNCTION__, ##arg)
#define MY_LOGW(fmt, arg...)        ALOGW("[DisplayThread::%s] " fmt, __FUNCTION__, ##arg)
#define MY_LOGE(fmt, arg...)        ALOGE("[DisplayThread::%s] " fmt, __FUNCTION__, ##arg)
#define MY_LOGA(fmt, arg...)        ALOGA("[DisplayThread::%s] " fmt, __FUNCTION__, ##arg)
#define MY_LOGF(fmt, arg...)        ALOGF("[DisplayThread::%s] " fmt, __FUNCTION__, ##arg)
//
